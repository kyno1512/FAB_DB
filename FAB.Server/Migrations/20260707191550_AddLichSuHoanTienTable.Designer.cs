...
namespace FAB.Server.Migrations
{
    ...
    [Migration("20260707191550_AddLichSuHoanTienTable")]
    partial class AddLichSuHoanTienTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FAB.Server.Models.DonHang", b =>
                {
                    ...
                    b.Property<string>("NguoiXuLyHoan")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("TrangThaiHuy")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("FAB.Server.Models.GiaSanPhamTheoSize", b =>
                {
                    ...
                    b.HasKey("MaGia")
                        .HasName("PK__GiaSanPh__A20E0F7E8B9A1235");

                    b.HasIndex("MaSanPham");

                    b.HasIndex("MaSize");

                    b.ToTable("GiaSanPhamTheoSize", (string)null);
                });
            ...
            modelBuilder.Entity("FAB.Server.Models.Lo", b =>
                {
                    b.Property<int>("MaLo")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasKey("MaLo")
                        .HasName("PK__Lo__272F6C9B3F6B7E8C");

                    b.HasIndex("MaNguyenLieu");

                    b.ToTable("Lo", (string)null);
                });
            ...
            modelBuilder.Entity("FAB.Server.Models.PhanQuyenNguoiDung", b =>
                {
                    ...
                    b.HasKey("MaPhanQuyen")
                        .HasName("PK__PhanQuyenNguoiDung__MaPhanQuyen");
            ...
            modelBuilder.Entity("FAB.Server.Models.Size", b =>
                {
                    b.Property<int>("MaSize")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasKey("MaSize")
                        .HasName("PK__Size__A20E0F7E8B9A1234");
            ...
            modelBuilder.Entity("FAB.Server.Models.ChiTietGioHang", b =>
                {
                    ...
                    b.HasOne("FAB.Server.Models.Size", "MaSizeNavigation")
                        .WithMany()
            ...
            modelBuilder.Entity("FAB.Server.Models.ChiTietPhieuNhapKho", b =>
                {
                    b.HasOne("FAB.Server.Models.Lo", "MaLoNavigation")
            ...
            modelBuilder.Entity("FAB.Server.Models.PhanQuyenNguoiDung", b =>
                {
                    b.HasOne("FAB.Server.Models.NguoiDung", "MaNguoiDungNavigation")
                        .WithMany("PhanQuyenNguoiDungs")
                        .HasForeignKey("MaNguoiDung")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("FAB.Server.Models.Quyen", "MaQuyenNavigation")
                        .WithMany("PhanQuyenNguoiDungs")
            ...
            modelBuilder.Entity("FAB.Server.Models.NguoiDung", b =>
                {
                    ...
                    b.Navigation("PhanQuyenNguoiDungs");
            ...
            modelBuilder.Entity("FAB.Server.Models.SanPham", b =>
                {
                    ...
                    b.Navigation("GiaSanPhamTheoSizes");
